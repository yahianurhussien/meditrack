...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        patientRepository.saveAll(List.of(
                new PatientEntity(null, "Alice", "Johnson", "123455666", "alice@example.com", LocalDate.of(1990,3,14)),
                new PatientEntity(null, "Michael", "Brown", "234535656",  "michael@example.com",LocalDate.of(1991,3,3)),
                new PatientEntity(null, "Sophia", "Lee", "123456456", "sophia@example.com",LocalDate.of(1993,3,23))
        ));
